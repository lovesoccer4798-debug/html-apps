...
- **最終更新**: 2026-09-15
- **更新者メモ**: TaskARE v99。PCカレンダーをNotion Calendar風の全幅レイアウトへ強化し、プロフィール帳一覧にお気に入り・グループ・検索・あかさたな絞り込みを追加。PRレビュー待ち
...
| [Task Calendar](../apps/task-calendar/README.md) | 🐣 ひな | 日／週／月／年＋タイマー＋繰り返し＋予定＋メモ＋ルーティンパッケージの個人用タスクカレンダー（PWA・共有カレンダー／思い出シェアカレンダー対応・アプリ内表示は v99） |
...
- [Task Calendar v1](in-progress/20260714-task-calendar.md)（本体はv99のPRレビュー待ち。Portal掲載の要否はオーナー判断）

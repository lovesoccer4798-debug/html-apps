...
- **最終更新**: 2026-09-13
- **更新者メモ**: TaskARE v98。v97のタイマー/プロフィール帳/Notion未反映日同期に続き、画像案ベースの配色テーマ5種とPC向け広幅レイアウトを追加。PRレビュー待ち
...
| [Task Calendar](../apps/task-calendar/README.md) | 🐣 ひな | 日／週／月／年＋タイマー＋繰り返し＋予定＋メモ＋ルーティンパッケージの個人用タスクカレンダー（PWA・共有カレンダー／思い出シェアカレンダー対応・アプリ内表示は v98） |
...
- [Task Calendar v1](in-progress/20260714-task-calendar.md)（本体はv98のPRレビュー待ち。Portal掲載の要否はオーナー判断）

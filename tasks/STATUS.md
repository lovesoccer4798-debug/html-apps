...
- **最終更新**: 2026-09-23
- **更新者メモ**: TaskARE v105のPR #89はマージ済み。v106で背景の連続性・ノート選択中のスワイプを修正、記念日メモ・情景タイマー2種・白い明暗ボタンを実装。ローカル検証済み。GitHub送信が安全審査で拒否され今回の送信承認待ち（PR未作成）。配信サーバー未設定、実機iPhoneの操作・通知受信は未確認。
...
- [Task Calendar v1](in-progress/20260714-task-calendar.md)（v105のPR #89はマージ済み。v106は送信承認待ち・PR未作成。Portal掲載の要否はオーナー判断）

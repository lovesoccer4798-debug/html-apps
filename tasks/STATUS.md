...
- **最終更新**: 2026-09-15
- **更新者メモ**: TaskARE v101。プロフィール帳にSNSリンクと、相手本人に書いてもらうプロフィール帳リンクを追加中。Firestoreルール追記が必要
...
- [Task Calendar v1](in-progress/20260714-task-calendar.md)（本体はv101のPR作成予定。Portal掲載の要否はオーナー判断）

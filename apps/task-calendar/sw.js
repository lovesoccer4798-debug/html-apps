...
const CACHE_NAME = 'task-calendar-v104';
const ASSETS = [
  './',
  './index.html',
  './style.css?v=104',
  './tokens.css?v=104',
  './app.js?v=104',
  './reminder-core.js?v=104',
  './reminder-client.js?v=104',
  './record-tools.js?v=104',
  './expressive-themes.css?v=104',
  './assets/collage.png',
  './assets/gallery.png',
  './firebase-config.js?v=104',
  ...
  './icons/icon-dark.svg?v=104',
  './icons/default-dark-180.png',
  './icons/logo-512.png',
  './icons/logo-dark-512.png',
  './icons/logo-180.png',
  './icons/logo-dark-180.png',
  './icons/favicon-32.png?v=104',
  './icons/apple-touch-icon.png?v=104',
  './icons/icon-192.png',
  './icons/icon-512.png',

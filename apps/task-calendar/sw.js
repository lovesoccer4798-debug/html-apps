...
const CACHE_NAME = 'task-calendar-v106';
const ASSETS = [
  './',
  './index.html',
  './style.css?v=106',
  './tokens.css?v=106',
  './app.js?v=106',
  './reminder-core.js?v=106',
  './reminder-client.js?v=106',
  './record-tools.js?v=106',
  './expressive-themes.css?v=106',
  './assets/collage.png',
  './assets/gallery.png',
  './assets/aquarium.png',
  './assets/woodland.png',
  './assets/cosmos.png',
  './firebase-config.js?v=106',
  './vendor/firebase-app-compat.js?v=29',
  './vendor/firebase-auth-compat.js?v=29',
  './vendor/firebase-firestore-compat.js?v=29',
  './manifest.webmanifest',
  './icons/icon.svg?v=106',
  './icons/icon-dark.svg?v=106',

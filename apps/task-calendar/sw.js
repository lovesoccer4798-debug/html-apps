...
const CACHE_NAME = 'task-calendar-v82';
const ASSETS = [
  './',
  './index.html',
  './style.css?v=82',
  ...
  './icons/icon.svg?v=82',
  './icons/icon-dark.svg?v=82',
  './icons/icon-hand.svg?v=82',
  './icons/icon-hand-dark.svg?v=82',
  './icons/default-dark-180.png',
  './icons/hand-180.png',
  './icons/hand-dark-180.png',
  './icons/favicon-32.png?v=82',
